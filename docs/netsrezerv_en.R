...
USDD <- getDataSeries("TP.DK.USD.A.EF.YTL", startDate = "01-01-2021", CBRTKey = myCBRTKey, freq = 1)

USD1 <- data.table(time = as.Date("2021-01-01"), TP.DK.USD.A.EF.YTL = as.numeric(7.4142))
...
setnames(mat, c("Valor Tarihi", "TCMB Doviz Karsiligi TL Swap Piyasasi", "TCMB Doviz Karsiligi TL Swap Piyasasi - Stok",
                ...
                "TCMB Doviz Karsiligi TL Swap Islemlerinden Depo Islemine Donen Islemler",
                "TCMB Doviz Karsiligi TL Swap Islemlerinden Depo Islemine Donen Islemler - Stok"))
...
mat[, doviz := 1000*doviz]

mat[, altin := 1000*altin]
