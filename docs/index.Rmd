...
<p style="color:red">Yaptığımız hesaplamalarda "ABD Doları(Döviz Alış)" verisini kullanıyorduk, fakat bunun yerine "ABD Doları(Efektif Alış)" verisini kullanmamız gerektiğini öğrendik. Hesaplamalarımızın hepsini ve Metodolojiyi bu doğrultuda güncellemiş bulunmaktayız. İki veri arasında sadece küçük bir küsürat farkı olsa da şeffaflık açısından yaptığımız düzeltmeyi siteyi takip eden sizlere duyurmak istedik. Ayrıca bu ve benzeri konulardaki bilgilendirmesi için @atk_1881 adlı Twitter kullanıcısına teşekkürlerimizi sunuyoruz.</p>

[Verileri İndir](https://github.com/mb-reserves/mb-reserves.github.io/raw/master/Tablo.xlsx)



## Çalışma Hakkında

<div style="float: right;"><a href="index_en.html">EN</a></div>
...
kullanılarak dolar cinsine çevirilmiştir. Hesaplamalarda günlük efektif döviz alış kuru (TP.DK.USD.A.EF.YTL) kullanılmıştır.
...
veri seti kullanılarak hazırlanmış ve alakalı gündeki efektif döviz alış kuruna bölünerek dolar cinsinden elde edilmiştir. 
