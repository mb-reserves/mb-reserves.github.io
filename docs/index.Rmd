...
<p style="color:red">Yaptığımız hesaplamalarda "ABD Doları(Döviz Alış)" verisini kullanıyorduk, fakat bunun yerine "ABD Doları(Efektif Alış)" verisini kullanmamız gerektiğini öğrendik. Hesaplamalarımızın hepsini ve Metodolojiyi bu doğrultuda güncellemiş bulunmaktayız. İki veri arasında sadece küçük bir küsürat farkı olsa da şeffaflık açısından yaptığımız değişikliği siteyi takip eden sizlere duyurmak istedik. Ayrıca bu ve benzeri konulardaki bilgilendirmesi için @atk_1881 adlı Twitter kullanıcısına teşekkürlerimizi sunuyoruz.</p>
